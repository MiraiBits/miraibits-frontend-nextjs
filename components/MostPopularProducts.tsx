        ...
        {products.map((product, index) => (
          ...
          >
            <div className="relative overflow-hidden rounded-xl bg-gray-50 dark:bg-gray-800">
              ...
              <span className="absolute bottom-3 right-3 rounded-full bg-gray-900/90 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-white shadow-md dark:bg-gray-100/90 dark:text-gray-900">
                Popular
              </span>
            </div>
